...
% Remove indentation \subsubsection
\makeatletter
\renewcommand\subsubsection{\@startsection{subsubsection}{3}{0pt}%
  {2ex \@plus1ex \@minus .2ex}       % Space above
  {1ex \@plus .2ex}                  % Space below
  {\normalfont\normalsize\itshape}}  % Italic style
\makeatother
...
% Document Title
% ---------------------------
\def\thetitle{Android GNSS Measurements under Spoofing and Interference}
\title{\thetitle}
...
\input{sections/03-results-and-discussions}
